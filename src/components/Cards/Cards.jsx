    ...
    return (
        <div className={styles.container}>
            <Grid container spacing={3} justify="center">
                <Grid item component={Card} xs={12} m={3} className={cn(styles.card, styles.infected)}>
                    <CardContent>
                ...
                <Grid item component={Card} xs={12} m={3} className={cn(styles.card, styles.recovered)}>
                    <CardContent>
                ...
                <Grid item component={Card} xs={12} m={3} className={cn(styles.card, styles.deaths)}>
                    <CardContent>
